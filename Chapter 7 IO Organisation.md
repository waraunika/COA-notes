...
- figure:
  ![Model of I/O module | 600][Images/chapter-7/io_module.png]
- functions:
	1. control & timing:
...
- structure:
		![IO Module block diagram][structure.png]
...
- figure:
  ![I/O bus connection][interface_module.png]
...
- example:
  ![example of interface | 600][example.png]
...
- Flowchart:
  ![Programmed IO flowchart | 200][programmed_io.png]
...
- figure:
  ![Data transfer from IO device to CPU | 600][programmed_io_block.png]
...
- flowchart for cpu program:
  ![CPU program to input data | 500][programmed_io_flowchart.png]
- characteristics:
...
- figure:
  ![Interrupt Processing | 500][interrupt_io.png]
- **Priority interrupts**:
...
- Priority Interrupt by **Hardware**:
	...
	- of two organisations of arrangement: **Daisy Chain (Serial) Priority** and **Parallel Priority**
	 1. **Daisy Chain Priority**
		 - figure:
		   ![Daisy Chain Priority Interrupt | 550][daisy_chain.png]
		 ...
		 - one stage figure:
		   ![One stage of DCP | 600][daisy_chain_stage.png]
	 2. **Parallel Priority**
		 - ![Parallel Priority interrupt hardware | 600][parallel_priority.png]
...
- Figure:
  ![CPU bus signal for DMA transfer | 600][dma_signals.png]
### DMA Controller
- Block diagram:
  ![Block Diagram of DMA controller | 600][dma_controller_block.png]
...
2. Arbitration Process:
	...
	- Figure: Transfer of data during arbitration:
	  ![DMA transfer in a computer system | 600][dma_transfer.png]
...
- Figure:
  ![Block Diagram of a computer with IOP | 600][iop_block.png]
...
- operation of typical IOP is described with example by CPU and IOP communication:
  ![CPU-IOP COmmunication | 550][cpu_iop_communication.png]
